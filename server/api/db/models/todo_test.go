...
var (
	todoDBTypes = map[string]string{`ID`: `integer`, `Title`: `character varying`, `Context`: `character varying`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`}
	_           = bytes.MinRead
)
